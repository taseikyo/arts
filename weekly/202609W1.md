...
本文总字数 19888 个，阅读时长约：73 分 14 秒，统计数据来自：[汤圆工具箱](https://zishutongji.zaixianapp.cn/)。
...
- [algorithm 🔝](#algorithm-)
    - [1. LCR152.验证二叉搜索树的后序遍历序列](#1-lcr152验证二叉搜索树的后序遍历序列)
        - [LCR152-DESC](#lcr152-desc)
        - [LCR152-CODE](#lcr152-code)
    - [2. LCR155.将二叉搜索树转化为排序的双向链表](#2-lcr155将二叉搜索树转化为排序的双向链表)
        - [LCR155-DESC](#lcr155-desc)
        - [LCR155-CODE](#lcr155-code)
    - [3. LCR156.序列化与反序列化二叉树](#3-lcr156序列化与反序列化二叉树)
        - [LCR156-DESC](#lcr156-desc)
        - [LCR156-CODE](#lcr156-code)
    - [4. LCR176.判断是否为平衡二叉树](#4-lcr176判断是否为平衡二叉树)
        - [LCR176-DESC](#lcr176-desc)
        - [LCR176-CODE](#lcr176-code)
    - [5. 235.二叉搜索树的最近公共祖先](#5-235二叉搜索树的最近公共祖先)
        - [235-DESC](#235-desc)
        - [235-CODE](#235-code)
    - [6. LCR194.二叉树的最近公共祖先](#6-lcr194二叉树的最近公共祖先)
        - [LCR194-DESC](#lcr194-desc)
        - [LCR194-CODE](#lcr194-code)
    - [7. LCR133.位1的个数](#7-lcr133位1的个数)
        - [LCR133-DESC](#lcr133-desc)
        - [LCR133-CODE](#lcr133-code)
    - [8. LCR134.Pow(x, n)](#8-lcr134powx-n)
        - [LCR134-DESC](#lcr134-desc)
        - [LCR134-CODE](#lcr134-code)
    - [9. LCR177.撞色搭配](#9-lcr177撞色搭配)
        - [LCR177-DESC](#lcr177-desc)
        - [LCR177-CODE](#lcr177-code)
    - [10. LCR190.加密运算](#10-lcr190加密运算)
        - [LCR190-DESC](#lcr190-desc)
        - [LCR190-CODE](#lcr190-code)
    - [11. LCR178.训练计划VI](#11-lcr178训练计划vi)
        - [LCR178-DESC](#lcr178-desc)
        - [LCR178-CODE](#lcr178-code)
    - [12. LCR126.斐波那契数](#12-lcr126斐波那契数)
        - [LCR126-DESC](#lcr126-desc)
        - [LCR126-CODE](#lcr126-code)
    - [13. LCR127.跳跃训练](#13-lcr127跳跃训练)
        - [LCR127-DESC](#lcr127-desc)
        - [LCR127-CODE](#lcr127-code)
    - [14. LCR161.连续天数的最高销售额](#14-lcr161连续天数的最高销售额)
        - [LCR161-DESC](#lcr161-desc)
        - [LCR161-CODE](#lcr161-code)
    - [15. 10.正则表达式匹配](#15-10正则表达式匹配)
        - [10-DESC](#10-desc)
        - [10-CODE](#10-code)
    - [16. LCR165.解密数字](#16-lcr165解密数字)
        - [LCR165-DESC](#lcr165-desc)
        - [LCR165-CODE](#lcr165-code)
    - [17. LCR166.珠宝的最高价值](#17-lcr166珠宝的最高价值)
        - [LCR166-DESC](#lcr166-desc)
        - [LCR166-CODE](#lcr166-code)
    - [18. LCR185.统计结果概率](#18-lcr185统计结果概率)
        - [LCR185-DESC](#lcr185-desc)
        - [LCR185-CODE](#lcr185-code)
    - [19. LCR187.破冰游戏](#19-lcr187破冰游戏)
        - [LCR187-DESC](#lcr187-desc)
        - [LCR187-CODE](#lcr187-code)
    - [20. LCR129.字母迷宫](#20-lcr129字母迷宫)
        - [LCR129-DESC](#lcr129-desc)
        - [LCR129-CODE](#lcr129-code)
    - [21. LCR130.衣橱整理](#21-lcr130衣橱整理)
        - [LCR130-DESC](#lcr130-desc)
        - [LCR130-CODE](#lcr130-code)
    - [22. LCR146.螺旋遍历二维数组](#22-lcr146螺旋遍历二维数组)
        - [LCR146-DESC](#lcr146-desc)
        - [LCR146-CODE](#lcr146-code)
    - [23. LCR188.买卖芯片的最佳时机](#23-lcr188买卖芯片的最佳时机)
        - [LCR188-DESC](#lcr188-desc)
        - [LCR188-CODE](#lcr188-code)
    - [24. 233.数字1的个数](#24-233数字1的个数)
        - [233-DESC](#233-desc)
        - [233-CODE](#233-code)
    - [25. 400.第N位数字](#25-400第n位数字)
        - [400-DESC](#400-desc)
        - [400-CODE](#400-code)
    - [26. 26.删除有序数组中的重复项](#26-26删除有序数组中的重复项)
        - [26-DESC](#26-desc)
        - [26-CODE](#26-code)
    - [27. 80.删除有序数组中的重复项II](#27-80删除有序数组中的重复项ii)
        - [80-DESC](#80-desc)
        - [80-CODE](#80-code)
    - [28. 122.买卖股票的最佳时机II](#28-122买卖股票的最佳时机ii)
        - [122-DESC](#122-desc)
        - [122-CODE](#122-code)
    - [29. 274.H指数](#29-274h指数)
        - [274-DESC](#274-desc)
        - [274-CODE](#274-code)
    - [30. 1356.根据数字二进制下1的数目排序](#30-1356根据数字二进制下1的数目排序)
        - [1356-DESC](#1356-desc)
        - [1356-CODE](#1356-code)
    - [31. 922.按奇偶排序数组II](#31-922按奇偶排序数组ii)
        - [922-DESC](#922-desc)
        - [922-CODE](#922-code)
    - [32. 402.移掉K位数字](#32-402移掉k位数字)
        - [402-DESC](#402-desc)
        - [402-CODE](#402-code)
    - [33. 134.加油站](#33-134加油站)
        - [134-DESC](#134-desc)
        - [134-CODE](#134-code)
    - [34. 2058.找出临界点之间的最小和最大距离](#34-2058找出临界点之间的最小和最大距离)
        - [2058-DESC](#2058-desc)
        - [2058-CODE](#2058-code)
- [review 🔝](#review-)
    - [1. 古文观止 - 石碏谏宠州吁](#1-古文观止---石碏谏宠州吁)
    - [2. 我的女友景甜](#2-我的女友景甜)
    - [3. 2026 大厂 Go 后端通关手册：35 道高频面试题深度解析](#3-2026-大厂-go-后端通关手册35-道高频面试题深度解析)
    - [4. How to loose time and money](#4-how-to-loose-time-and-money)
    - [5. 古文观止 - 臧僖伯谏观鱼](#5-古文观止---臧僖伯谏观鱼)
- [tip 🔝](#tip-)
    - [1. go slice扩容机制](#1-go-slice扩容机制)
        - [1.18 之前的扩容策略](#118-之前的扩容策略)
        - [1.18+ 的扩容策略变化](#118-的扩容策略变化)
- [share 🔝](#share-)
    - [1. 损失厌恶（Loss Aversion）与禀赋效应（Endowment Effect）](#1-损失厌恶loss-aversion与禀赋效应endowment-effect)
        - [损失厌恶（Loss Aversion）：人性最底层的“操作系统”](#损失厌恶loss-aversion人性最底层的操作系统)
        - [禀赋效应（Endowment Effect）：损失厌恶在“所有权”上的投射](#禀赋效应endowment-effect损失厌恶在所有权上的投射)
        - [两者关键区别：一张表看明白](#两者关键区别一张表看明白)
        - [用一个场景帮你“合并同类项”](#用一个场景帮你合并同类项)
        - [如何“双杀”这两个心理陷阱？（行动指南）](#如何双杀这两个心理陷阱行动指南)
...
### 34. [2058.找出临界点之间的最小和最大距离](https://leetcode.cn/problems/find-the-minimum-and-maximum-number-of-nodes-between-critical-points/description/?envType=daily-question&envId=2026-08-31)
...
### 1. 损失厌恶与禀赋效应（Loss Aversion and Endowment Effect）

#### 损失厌恶（Loss Aversion）：人性最底层的“操作系统”

这是诺贝尔奖得主丹尼尔·卡尼曼的核心发现。

它的定义极其精悍：

> **失去100块钱的痛苦，远远大于得到100块钱的快乐。**（心理权重比大约是 **2.5 : 1**）

什么意思？你在路边捡到100块，开心程度如果是+10分；那么你丢了100块，痛苦程度是-25分。

也就是说，**你为了规避“失去”而愿意付出的努力，是你为了“得到”同等东西而努力的两倍多。**

**日常场景**：

- **股市里的“死扛”**：你买了只股票，涨了10%你急着想卖（落袋为安）；但跌了10%，你绝对不卖，因为“卖了就是真亏了”，宁可死扛到退市。这就是损失厌恶在作祟。
- **商家的“限时购”**：商家说“今天不买，明天涨价300块”，这句话对你的杀伤力，远大于“今天买，比明天便宜300块”。因为前者让你感觉“会失去省钱的机会”，痛苦感更强。

#### 禀赋效应（Endowment Effect）：损失厌恶在“所有权”上的投射

禀赋效应就是**损失厌恶的亲儿子**。它的逻辑链条是这样的：

1. 人天生害怕失去（损失厌恶）。
2. 一旦某样东西归我所有了，它就和我绑定了。
3. 这时候，**“失去它”的痛苦**就被激活了。
4. 为了不承受失去的痛苦，我潜意识里**拔高了对它的估值**。

所以，禀赋效应就是：**“因为怕失去，所以我高估了我拥有的东西。”**

**日常场景**：

- **闲鱼高价**：你的旧手机，因为“你的”，你给它加上了回忆和习惯的情感分，卖价远高于市场行情。而买家没有拥有过它，只看到裸机，所以出价客观。

#### 两者关键区别：一张表看明白

| 对比维度 | **损失厌恶**（底层逻辑） | **禀赋效应**（上层表现） |
| :--- | :--- | :--- |
| **核心公式** | 得失不对称（失 > 得） | 因为怕失，所以高估所有物 |
| **针对对象** | 针对**任何**东西的得失（钱、机会、面子） | 专门针对**你正在拥有**的东西 |
| **经典问题** | “我敢不敢冒这个险？” | “我舍得卖/扔这个吗？” |
| **锚定标准** | 以“现状”为参照点 | 以“这是我的”为参照点 |
| **决策后果** | 导致**风险回避**（不敢轻易行动） | 导致**现状偏见**（维持原状，不愿交换） |

#### 用一个场景帮你“合并同类项”

假设你**抽奖中了一张价值600块的演唱会门票**（你拥有了它）。

- **如果你把票卖了**：你会想，这张票市面上有人出800收。但你想：“万一以后再也抽不到了呢？而且我为了去这场演唱会，都跟朋友吹过牛了。” 这时候你觉得**少于900块绝对不卖**（这是**禀赋效应**：你高估了这张票）。
- **如果你票没中，而是丢了600块现金**：你心痛得午饭都吃不下，甚至想请假去路边找（这是**损失厌恶**：失去600块的痛苦远大于你当初买彩票中奖的快乐）。

**更精妙的是**：

如果你没中票，让你掏600块去买，你会嫌贵（觉得不值）。

但你已经拥有了票，让你按市场价600卖掉，你也不乐意（觉得亏了）。

**同一个东西，买的时候嫌贵，卖的时候嫌便宜**——这就是禀赋效应，而驱动这一切的底层发动机，就是损失厌恶。

#### 如何“双杀”这两个心理陷阱？（行动指南）

既然知道“失＞得”是人性，所有权会放大估值，那破局的关键就是**人为地“切换视角”**。

**方法1：用“第三方视角”拷问自己（破禀赋）**

在做买卖或去留决策时，不要问“这东西跟我几年了”，而要问：

> **“如果我现在手里没有这个东西，我今天愿意花多少钱重新得到它？”**
如果答案是否定的，果断放手。

**方法2：把“不作为”的损失写出来（破损失厌恶）**

因为害怕损失，我们习惯维持现状（不换工作、不分手、不搬家）。这时候，**不要只看“行动会失去什么”，要白纸黑字列出“不行动正在失去什么”**。

- 比如：不换工作，**正在损失**每年3万的涨薪、更好的职业前景。
- 当你发现“不作为的隐性损失”已经大过“行动的显性损失”时，损失厌恶的天平就被扳平了。

**方法3：把“心理账户”和“物理账户”分开**

丢了100块，没必要为了“扳回一城”去赌场冒险（这是损失厌恶导致的“赌徒心态”）。

同样，花了50块看电影，不好看就立刻走人，不要因为“票是我的”就硬熬两个小时（这是禀赋效应导致的“浪费生命”）。**钱已经回不来了，但时间还是你的。**
